...
import { Upload, FileAudio, X, Users, Loader2, Clock, AlertCircle, Download, Copy, Check, Sparkles, AlertTriangle } from "lucide-react"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 dark:text-amber-300 mt-1">
                  Your transcription is being processed. Leaving this page will cancel the process and your progress will be lost.
                </p>
              </div>
            </div>
          </CardContent>
